...
import classes from "../../routes/paper+/$paperId+/layout.module.css";
...
/** Legacy DSR paper workspace layout — unchanged when PAPER_V2_FLOW=false */
export function PaperV1Layout() {
  ...
  const data = useLoaderData<PaperLayoutLoaderData>();
